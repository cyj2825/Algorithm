...
//	private static void dfs(int cur, boolean x) {
//		visited[cur] = true;
//		if(x) {
//			if(!check.isEmpty() && check.contains(cur)) {
//				check.remove((Object) cur);
//			}
//		}else {
//			if(!check2.isEmpty() && check2.contains(cur)) {
//				check2.remove((Object) cur);
//			}
//		}
//		
//		for(int i = 0, end = list[cur].size(); i < end; i++) {
//			int ad = list[cur].get(i);
//			if(!visited[ad]) dfs(ad, x);
//		}
//	}
